...
//			out.println("					<a class=\"btn btn-secondary\" href=\"../actions/EditAssessment?semesterId=" + semesterId + "&courseId=" + courseId +  "&assessmentId=" + i + "\" role=\"button\">Edit</a>");
			out.println("					<a href=\"../actions/EditAssessment?semesterId=" + semesterId + "&courseId=" + courseId +  "&assessmentId=" + i + "\" role=\"button\">Edit</a>");
//			out.println("					<a class=\"btn btn-danger\" href=\"../actions/DeleteAssessment?semesterId=" + semesterId + "&courseId=" + courseId +  "&assessmentId=" + i + "\" role=\"button\">Delete</a>");
			out.println("					<a href=\"../actions/DeleteAssessment?semesterId=" + semesterId + "&courseId=" + courseId +  "&assessmentId=" + i + "\" role=\"button\">Delete</a>");
			out.println("				</h3>");
