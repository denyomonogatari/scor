...
public class MainPage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("	<h2 class=\"display-2\">Hello, " + user.getFirst() + "</h2>");
		...
		out.println("			</ul>");
		out.println("		<form action=\"../actions/AddSemester\" method=\"post\">");
		out.println("			<legend>Add Semester</legend>");
		out.println("		<div class=\"row\">");
		out.println("			<div class=\"col\">");
		out.println("				<input type=\"text\" maxlength=\"6\" class=\"form-control\" name=\"term\" placeholder=\"Term\">");
		out.println("			</div>");
		out.println("			<div class=\"col\">");
		out.println("				<input type=\"text\" class=\"form-control\" name=\"year\" placeholder=\"Year\">");
		out.println("			</div>");
		out.println("			<div class=\"col\">");
		out.println("				<input type=\"submit\" class=\"btn btn-primary\"value=\"Add Semester\">");
		out.println("			</div>");
		out.println("		</div>");
		out.println("		</form>");
		out.println("		</div>");
