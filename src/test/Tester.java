...
public class Tester {
	public static void main(String[] args) {
		...
		Assignment lab1 = new Assignment("Hello World Program", 95, 100, true, false, new Date(currentMilliseconds),
				new Date(currentMilliseconds + 100_000_000));
		...
		homework.addAssignment(
				new Assignment("HW1: Create Notes", 95, 100, true, false, new Date(currentMilliseconds), null));
		...
		Assignment assignment2 = new Assignment("Lab2", 10, 13, true, false, null, null);
		Assignment assignment3 = new Assignment("Lab3", 11, 13, true, false, null, null);
		Assignment assignment4 = new Assignment("Midterm", 30, 37, true, false, null, null);
		Assignment assignment5 = new Assignment("Homework 1", 9, 10, true, false, null, null);
		Assignment assignment6 = new Assignment("Homework 2", 8, 10, true, false, null, null);
		Assignment assignment7 = new Assignment("Final", 83, 100, true, false, null, null);
		...
		Assessment assessment5 = new Assessment("Homework and Lab Assignments", 20);
		Assessment assessment6 = new Assessment("Quizzes", 25);
		Assessment assessment7 = new Assessment("Midterm Exams", 25);
		Assessment assessment8 = new Assessment("Final Exam", 25);
		Assessment assessment9 = new Assessment("Attendence", 5);
		...
		Assignment assignment14 = new Assignment("HTTP Requests", 9, 10, true, false, null, null);
		Assignment assignment15 = new Assignment("HTTP Responses", 8, 10, true, false, null, null);
		...
		Assignment assignment19 = new Assignment("Final", 85, 100, true, false, null, null);
