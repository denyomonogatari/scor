...
var converter = {
  convert: function (e) {
    ...
    if (t && console.log(t), e.classList.contains('js-converter-gradeScale')) {
      var n = [
        0,
        1,
        1.3,
    ...
    } else r.selectedIndex = s.selectedIndex = e.selectedIndex,
    l.value = a.toFixed(1);
...
var calculator = {
  ...
  calculateGPA: function () {
    ...
    try {
      for (var o, i = function () {
        ...
        L && a < L ? (h.classList.add('is-below'), setTimeout(function () {
          h.classList.remove('is-below')
      ...
      for (var i, u = a[Symbol.iterator](); !(n = (i = u.next()).done); n = !0) {
        ...
        try {
          for (var L, N = y[Symbol.iterator](); !(v = (L = N.next()).done); v = !0) {
            var j = L.value,
            I = parseFloat(j.getElementsByClassName('js-assessment-weight') [0].value),
  ...
  render: function (e) {
    ...
    if (document.getElementsByClassName('js-weight-toggle')) {
      ...
      C = b.getElementsByClassName('js-weight-toggle'),
      O = b.getElementsByClassName('js-course-weight');
      ...
      document.body.classList.contains('college-gpa-calculator') ? calculator.weightIsOff || calculator.toggleWeight(C[0], 'update')  : document.body.classList.contains('high-school-gpa-calculator') && calculator.weightIsOff && calculator.toggleWeight(C[0], 'update');
      var x = !0,
      T = !1,
      A = undefined;
      try {
        for (var M, P = C[Symbol.iterator](); !(x = (M = P.next()).done); x = !0) {
          var F = M.value,
          J = 'toggle-' + Math.round(10000 * Math.random());
      ...
      H = undefined;
      try {
        for (var W, D = O[Symbol.iterator](); !(G = (W = D.next()).done); G = !0) {
  ...
  setLocalStorage: function () {
    ...
    return 'gpa' == calculator.type ? t = [
      calculator.semesterTemplate
    ] : 'grade' == calculator.type && (t = [
      calculator.klassTemplate
    ]),
  ...
  updateLocalStorage: function (e, t) {
    ...
    if ('create' == t) 'course' == e.dataset.type ? l[n].push(calculator.courseTemplate)  : 'semester' == e.dataset.type ? l.push(calculator.semesterTemplate)  : 'assessment' == e.dataset.type ? l[n].push(calculator.assessmentTemplate)  : 'class' == e.dataset.type && l.push(calculator.klassTemplate),
    localStorage.setItem(a, JSON.stringify(l));
     else if ('remove' == t) 'LI' == c.tagName ? l[i].splice([n], 1)  : l.splice([n], 1),
    localStorage.setItem(a, JSON.stringify(l));
     else if ('update' == t) {
      var u = e.dataset.type,
      d = e.value;
      if ('weightToggle' == u) l = JSON.parse(localStorage.getItem('gpa-data')) || {
      },
      l.weightIsOff = calculator.weightIsOff,
      localStorage.setItem('gpa-data', JSON.stringify(l));
       else if ('currentGrade' == u || 'currentCredits' == u) l = JSON.parse(localStorage.getItem('gpa-data')) || {
      },
      l[u] = parseFloat(d),
      localStorage.setItem('gpa-data', JSON.stringify(l));
       else {
